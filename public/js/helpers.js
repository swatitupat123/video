    ...
    getroomName(url = '', keyToReturn = '') {
        ...
        if (queryStrings) {
            ...
            if (splittedQStrings.length) {
                ...
                if (keyToReturn) {
                    // Check if the 'room' parameter exists and return its value
                    return queryStringObj[keyToReturn] ? queryStringObj[keyToReturn].split('_')[0] : null;
                } else {
                    // Return the entire queryStringObj
